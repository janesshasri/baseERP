...
<html lang="en">
    <head>
        ...
        <title>Thuli Ice Creams</title>
        <meta name="description" content="Online GST Accounting Software">
        <meta name="author" content="">

        <!-- Favicon -->
        <link rel="shortcut icon" href="assets/images/avatars/thuli-favicon.png">
...
<div id="main">
    ...
    <div class="headerbar">
        ...
        <div class="headerbar-left">
            <a href="index.php" class="logo"><img alt="Logo" src="assets/images/avatars/thuli favicon1.png" /> <font color="yellow"><span><b>Thuli Ice Creams</b></span></font></a>
        </div>
...
<li><a href="listBankDeposit.php"><i class="fa fa-plus-circle"></i>List Bank deposit</a></li>
					...
					<li class="submenu">
                        ...
                        <a href"><i class="fa fa-cc-mastercard bigfonts" aria-hidden="true"></i>Payments<span class="menu-arrow"></span></a>	                        
                        <ul class="list-unstyled">	
                            
							<li><a href="listPayeeMaster.php"><i class="fa fa-user-md bigfonts" aria-hidden="true"></i>add Supplier/Payee Account</a></li>
									<li><a href="payeeMasterReport.php"><i class="fa fa-fw fa-table"></i> <span> Payee/Supplier Reports</span></a></li>
