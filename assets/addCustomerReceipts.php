...
<a href="#" onclick="show_credits_input();">Use Credits</a>
        ...
        <script>
            ...
            function oninvoice_select(val){
                ...
                page_phone_number = inv_data.inv_billing_phone;
                page_msg = "Dear Customer("+inv_data.inv_customer+"), Thanks for receiving payment for your invoice #"+inv_data.inv_code+" and amount  "+inv_data.inv_value+". Regards, Thuli Ice Creams";
