...
<head>
	...
	<head>
		...
		<title>Thuli Icecreams Pvt Ltd.,</title>
		<meta name="description" content="Free Bootstrap 4 Admin Theme | Pike Admin">
		<meta name="author" content="Pike Web Development - https://www.pikephp.com">

		<!-- Favicon -->
		<!--link rel="shortcut icon" href="assets/images/favicon.ico" -->
		<link rel="shortcut icon" href="assets/images/thuli favicon.png">
...
<div class="container h-100">
	<div class="row h-100 align-items-center">
	   <div class="col-md-4 offset-md-4">
		<div class="card">
			<h3 class="card-header"><img alt="Logo" src="assets/images/avatars/thuli favicon1.png" /> 
			<div class="invoice-title text-center mb-3">Thuli Ice Creams</a></div></h3>
