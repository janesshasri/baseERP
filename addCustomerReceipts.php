        ...
        <script>
            ...
            $("form#add_cust_payment_form").submit(function(e){
                ...
                $.ajax ({
                    ...
                    success:function(response){
                        if(page_inv_data){
                            page_phone_number = page_inv_data.inv_billing_phone;
                            page_msg = "Dear Customer("+page_inv_data.inv_customer+"), We received your payment of  Rs."+data.cust_payment_amount+" against the Invoice#"+page_inv_data.inv_code+" of Invoice Value Rs."+page_inv_data.inv_value+". Thanks, Thuli Ice Creams";

                            var sms_stat = Page.send_sms(page_msg, page_phone_number);
